...
if(params$last_election_period){
  ...
  trs <- stanpop:::rmd_known_state_period_time_range(pops)
  K <- length(trs)
...
if(params$election_campaigns){
  ...
  trs <- stanpop:::rmd_known_state_campaign_time_range(pops, months = 6L)
...
if(params$diagnostics_table){
  ...
  knitr::kable(stanpop:::rmd_model_diagnostic_table(pops), 
               digits = 1, 
...
if(params$model_information){
  ...
  mi <- stanpop:::rmd_model_settings(pops)
