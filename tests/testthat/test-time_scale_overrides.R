...
test_that("normalize_time_scale_overrides applies inclusive override ranges", {
  ...
  expected_scales <- c("week", "week", "day", "day", "day", "week", "week", "month", "month", "week")
  expect_identical(schedule$time_scale, expected_scales)
  expect_identical(schedule$time_scale_days, c(7L, 7L, 1L, 1L, 1L, 7L, 7L, 30L, 30L, 7L))
})
